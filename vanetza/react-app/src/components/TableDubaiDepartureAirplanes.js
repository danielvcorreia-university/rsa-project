...
class TableDubaiDepartureAirplanes extends React.Component {
    ...
    componentDidMount() {
        AirplaneService.get_dubai_departure_airplanes().then((response) => {
    ...
    render() {
        return (
            ...
            <div className="table-container">
                ...
                <br></br>
                <h1 className="center"> Departure Airplanes </h1>
                <br></br>
...
export default TableDubaiDepartureAirplanes