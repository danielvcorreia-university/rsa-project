...
class TableDubaiArrivalAirplanes extends React.Component {
    ...
    componentDidMount() {
        AirplaneService.get_dubai_arrival_airplanes().then((response) => {
    ...
    render() {
        return (
            ...
            <div className="table-container">
                ...
                <br></br>
                <h1 className="center"> Arrival Airplanes </h1>
                <br></br>
...
export default TableDubaiArrivalAirplanes